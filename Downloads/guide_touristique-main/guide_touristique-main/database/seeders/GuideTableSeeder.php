...
class GuideTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('users')->insert([
            ['date_naissance'=>'2002-02-03' ,'cine'=>'ee564647','name'=>'ahmmed' , 'prenom'=>'aluoi' ,'username'=>'alaoui_ahmed' , 'photo'=>'guide1.jpg' , 'email'=>'ahmed@gmail.com' , 'password'=>bcrypt('2002') , 'isGuide'=>1 ] ,
            ['date_naissance'=>'2002-02-04' ,'cine'=>'ee564657','name'=>'yassir' , 'prenom'=>'badr' ,'username'=>'yassir_badr' , 'photo'=>'guide2.jpg' , 'email'=>'yassir@gmail.com' , 'password'=>bcrypt('2002') , 'isGuide'=>1] ,
